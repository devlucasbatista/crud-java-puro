...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Instancia o DAO para acessar o banco
        ...
        // Insere os clientes no banco
        dao.criar(cliente1);
        dao.criar(cliente2);
        dao.criar(cliente3);
        dao.criar(cliente4);

        // Lista e exibe todos os clientes
        List<Cliente> clientes = dao.listar();
        for (Cliente c : clientes) {
            System.out.println(c.getId() + " - " + c.getNome() + " - " + c.getEmail());
        }

        // Atualiza o nome do cliente4
        cliente4.setNome("Bom dia Atualizado");
        dao.atualizar(cliente4);

        // Deleta o cliente de id 3
        dao.deletar(3);
    }
}